 ...
 */
public class StudentRoleRepository extends SpringbootJpaApplicationTest{
    ...
    public void testDelete() {
        Student student = new Student();
        student.setId(3L);
        Optional<Student> one = studentRepository.findOne(Example.of(student));
        studentRepository.delete(one.get());
    }
