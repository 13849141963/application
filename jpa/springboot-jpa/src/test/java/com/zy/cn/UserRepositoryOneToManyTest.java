 ...
 */
public class UserRepositoryOneToManyTest extends SpringbootJpaApplicationTest{
    ...
    public void testDelete(){
        User user = new User();
        user.setId(25L);
        Optional<User> one = userRepositoryOneToMany.findOne(Example.of(user));
        userRepositoryOneToMany.delete(one.get());
    }
    ...
    public void testGetAll(){
        ...
        user.setId(23L);
        Optional<User> one = userRepositoryOneToMany.findOne(Example.of(user));
        Set<LinkMan> linkMans = one.get().getLinkMans();
    ...
    public void testGetAll2(){
        ...
        LinkMan linkMan = new LinkMan();
        linkMan.setId(9L);
        Optional<LinkMan> one = linkManRepository.findOne(Example.of(linkMan));
        User user = one.get().getUser();
